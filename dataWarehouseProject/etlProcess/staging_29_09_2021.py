...
def create_staging_summary(df):   
    ...
    DatabaseInterface().drop_table('staging_29_09_2021.SUMMARY_INFORMATION')
    df.to_sql('SUMMARY_INFORMATION', DatabaseInterface().getConnection(engine = True), index = True, if_exists='append',schema='staging_29_09_2021')
    return(df)
...
def create_staging_protocol(df):   
    ...
    df=df.drop_duplicates()
    DatabaseInterface().drop_table('staging_29_09_2021.PROTOCOL_INFORMATION')
    df.to_sql('PROTOCOL_INFORMATION', DatabaseInterface().getConnection(engine = True), index = True, if_exists='append',schema='staging_29_09_2021')
    return(df)
...
def create_staging_sponsor(df): 
    ...
    df=df.drop_duplicates()
    DatabaseInterface().drop_table('staging_29_09_2021.SPONSOR_INFORMATION')
    df.to_sql('SPONSOR_INFORMATION', DatabaseInterface().getConnection(engine = True), index = True, if_exists='append',schema='staging_29_09_2021')
    return(df)
...
def create_staging_imp(df):  
    ...
    df=df.drop_duplicates()    
    DatabaseInterface().drop_table('staging_29_09_2021.IMP_IDENTIFICATION')
    df.to_sql('IMP_IDENTIFICATION', DatabaseInterface().getConnection(engine = True), index = True, if_exists='append',schema='staging_29_09_2021')
    return(df)
...
def create_staging_trial(df):   
    ...
    df=df.drop_duplicates()
    DatabaseInterface().drop_table('staging_29_09_2021.TRIAL_INFORMATION')
    df.to_sql('TRIAL_INFORMATION', DatabaseInterface().getConnection(engine = True), index = True, if_exists='append',schema='staging_29_09_2021')
    return(df)
...
def create_trial_subject(df): 
    ...
    df=df.drop_duplicates()
    DatabaseInterface().drop_table('staging_29_09_2021.TRIAL_SUBJECT_INFO')
    df.to_sql('TRIAL_SUBJECT_INFO', DatabaseInterface().getConnection(engine = True), index = True, if_exists='append',schema='staging_29_09_2021')
    return(df)
...
def create_trial_review(df):
    ...
    df=df.drop_duplicates()
    DatabaseInterface().drop_table('staging_29_09_2021.TRIAL_REVIEW_INFO')
    df.to_sql('TRIAL_REVIEW_INFO', DatabaseInterface().getConnection(engine = True), index = True, if_exists='append',schema='staging_29_09_2021')
    return(df)
...
def create_time_dimention(df):
    ...
    df=df.drop_duplicates()
    DatabaseInterface().drop_table('staging_29_09_2021.TIME_DIMENTION')
    df.to_sql('TIME_DIMENTION', DatabaseInterface().getConnection(engine = True), index = True, if_exists='append',schema='staging_29_09_2021')
    return(df)
## Read from Ingestion Table

df = pd.read_sql_table('load_txt',DatabaseInterface().getConnection(engine = True),schema='staging_29_09_2021')
